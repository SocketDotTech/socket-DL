...
// npx ts-node scripts/admin/unTripGlobal.ts  - check trip status for all mainnet chains
// npx --chains=421614  ts-node scripts/admin/unTripGlobal.ts
// npx --sendtx --chains=421614  ts-node scripts/admin/unTripGlobal.ts
// npx --sendtx --chains=421614 --integration=fast ts-node scripts/admin/unTripGlobal.ts
// npx --sendtx --chains=421614 --testnets --integration=fast ts-node scripts/admin/unTripGlobal.ts
