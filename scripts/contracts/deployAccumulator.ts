...
export default async function deployAccumulator(socketAddress: string, notaryAddress: string, signer: SignerWithAddress) {
  try {
    const contractName = "SingleAccum";
    const args = [socketAddress, notaryAddress]
